...
export default function CharacterGridCard({
  ...
  return (
    <div className="bg-white rounded-lg flex flex-col items-center shadow-[10px_10px_0px_0px_#000000] border border-slate-500 overflow-hidden hover:shadow-[16px_16px_0px_0px_#000000] duration-300 hover:scale-105 transition-all">
